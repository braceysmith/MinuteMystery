...
namespace DreamscapeAssets.Utils
{
	...
	public class BlockPop : MonoBehaviour
	{
		...
		[SerializeField] private float m_PopSpeed = 5f;         // The speed at which the item should pop out.
		[SerializeField] private float m_PopDistance = 5f;    // The distance the item should pop out.
